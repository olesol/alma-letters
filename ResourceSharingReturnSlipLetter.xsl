    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                ...
                <!-- Inserting Norwegian LIB-code -->
                <hr/>
                
                Lib Code:
                <h1>
                    <xsl:value-of select="substring(/notification_data/partner_address/line5, 4,3)"/>&#160;&#160;&#160;<xsl:value-of select="substring(/notification_data/partner_address/line5, 7,4)"/>
                </h1>
