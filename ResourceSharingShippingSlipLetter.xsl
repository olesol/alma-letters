      ...
      <tr>
       <td>
        ...
        <xsl:value-of select="notification_data/partner_name"/>
         ...
         <xsl:value-of select="state"/>&#160;<xsl:value-of select="country"/><br/>
        </xsl:for-each>
       <br/><br/>
       <b>@@email@@: </b> <xsl:value-of select="notification_data/email"/><br/>
       <b>@@phone@@: </b> <xsl:value-of select="notification_data/phone"/>
      </td>
      </tr>
